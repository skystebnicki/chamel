...
var Drawer = function (_React$Component) {
  ...
  _createClass(Drawer, [{
    ...
    value: function render() {
      ...
      var theme = this.context.chamelTheme && this.context.chamelTheme.drawer ? this.context.chamelTheme.drawer : {};

      // Set the classes
      var classes = (0, _classnames3.default)(theme.drawer, (_classnames = {}, _defineProperty(_classnames, theme.drawerClosed, !this.props.open), _defineProperty(_classnames, theme.drawerClipped, this.props.clipped), _defineProperty(_classnames, theme.drawerPermanent, this.props.permanent), _defineProperty(_classnames, theme.drawerFloating, !this.props.permanent), _defineProperty(_classnames, theme.drawerTransparent, this.props.zIndex == 0), _classnames), this.props.className);

      var overlay = void 0;

      if (!this.props.permanent) overlay = _react2.default.createElement(_Overlay2.default, { show: this.props.open, onClick: this._onOverlayTouchTap });
