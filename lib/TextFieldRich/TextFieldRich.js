...
var TextFieldRich = _react2.default.createClass({
	...
	propTypes: {
		...
		autoGrow: _react2.default.PropTypes.bool,
  ...
  */
	_getIframeWindow: function _getIframeWindow() {
		...
		var ifrm = _reactDom2.default.findDOMNode(this.refs.rte);
  ...
  */
	_enableDesign: function _enableDesign(on) {
		...
		// Set document events
		var evtObj = uaParser.getBrowser().name == "IE" ? _reactDom2.default.findDOMNode(this.refs.rte) : this._getIframeWindow();
