...
var TextField = function (_React$Component) {
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      var skipGetData = _props.skipGetData;
      var autoComplete = _props.autoComplete;
      var autoCompleteData = _props.autoCompleteData;
      var autoCompleteGetData = _props.autoCompleteGetData;
      var autocompleteTrigger = _props.autocompleteTrigger;
      var autocompleteDelimiter = _props.autocompleteDelimiter;

      var other = _objectWithoutProperties(_props, ['className', 'errorText', 'floatingLabelText', 'hintText', 'id', 'multiLine', 'isFocus', 'onBlur', 'onChange', 'onFocus', 'onClick', 'type', 'value', 'skipGetData', 'autoComplete', 'autoCompleteData', 'autoCompleteGetData', 'autocompleteTrigger', 'autocompleteDelimiter']);
