        ...
        if (triggerDelimiter) {
          for (var idx in triggerDelimiter) {
            ...
            if (subValue.lastIndexOf(td) >= 0) {
              _details.startPos = subValue.lastIndexOf(td);
              break;
            }
          }
        }

        if (this.props.autoCompleteTrigger == null && _details.startPos == -1) {
           ...
           */
          _details.startPos = 0;
        } else if (this.props.autoCompleteTrigger && _details.startPos >= 0) {
          _details.startPos += 1;
        }
      }
