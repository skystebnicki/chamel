...
var TextField = function (_React$Component) {
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props, ['className', 'errorText', 'floatingLabelText', 'hintText', 'id', 'multiLine', 'onBlur', 'onChange', 'onFocus', 'onClick', 'type', 'value', 'skipGetData', 'autoComplete', 'autoCompleteData', 'autoCompleteGetData', 'autocompleteTrigger', 'autocompleteDelimiter']);
