  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          other = _objectWithoutProperties(_props, ['className', 'errorText', 'floatingLabelText', 'hintText', 'id', 'multiLine', 'onBlur', 'onChange', 'onFocus', 'onClick', 'type', 'value', 'skipGetData', 'autoComplete', 'autoCompleteData', 'autoCompleteGetData', 'autocompleteTrigger', 'autocompleteDelimiter']);
