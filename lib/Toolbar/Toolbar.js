...
var _ChevronLeftIcon = require("../icons/font/ChevronLeftIcon");

var _ChevronLeftIcon2 = _interopRequireDefault(_ChevronLeftIcon);

var _ChevronRightIcon = require("../icons/font/ChevronRightIcon");
      ...
      if (toolbarIcons.length != 0 && totalIconsWidth > this.state.chamelToolbarWidth) {
        ...
        if (this.state.startIconIndex > 0) {
          displayArrowLeft = _react2.default.createElement(
            "div",
            { className: theme.chamelToolbarLeftArrow },
            _react2.default.createElement(
              _IconButton2.default,
              { onTap: function onTap(e) {
                  _this2._handleArrowClick(-1);
                } },
              _react2.default.createElement(_ChevronLeftIcon2.default, null)
            )
          );
        } else {
          displayArrowLeft = _react2.default.createElement("div", { className: theme.chamelToolbarLeftArrow });
        }
        ...
        if (this.state.startIconIndex + displayIcons.length < toolbarIcons.length) {
          displayArrowRight = _react2.default.createElement(
            "div",
            { className: theme.chamelToolbarRightArrow },
            _react2.default.createElement(
              _IconButton2.default,
              { onTap: function onTap(e) {
                  _this2._handleArrowClick(1);
                } },
              _react2.default.createElement(_ChevronRightIcon2.default, null)
            )
          );
        }
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            "div",
            { ref: "chamelToolbar", className: this.toolbarGroup, style: iconContainerStyle },
            displayIcons
          ),
          displayArrowRight
        );
