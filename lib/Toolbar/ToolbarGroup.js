...
var ToolbarGroup = function (_React$Component) {
  ...
  _createClass(ToolbarGroup, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames3.default)(theme.toolbarGroup, (_classnames = {}, _defineProperty(_classnames, theme.toolbarGroupLeft, this.props.float === 'left'), _defineProperty(_classnames, theme.toolbarGroupRight, this.props.float === 'right'), _classnames));
