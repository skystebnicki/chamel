...
var Dialog = function (_React$Component) {
  ...
  function Dialog(props) {
    ...
    _this.dismiss = function () {
      _CssEvent2.default.onTransitionEnd(_reactDom2.default.findDOMNode(_this), function () {
  ...
  _createClass(Dialog, [{
    ...
    value: function render() {
      ...
      var theme = this.context.chamelTheme && this.context.chamelTheme.dialog ? this.context.chamelTheme.dialog : {};
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { ref: 'dialogBody', className: theme.dialogWindowBody },
              this.props.children
            ),
            actions
          )
    ...
    value: function _getActionsContainer(actions) {
      // Determine which theme to use
      var theme = this.context.chamelTheme && this.context.chamelTheme.dialog ? this.context.chamelTheme.dialog : {};
