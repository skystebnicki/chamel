...
var AutoComplete = function (_React$Component) {
  ...
  _createClass(AutoComplete, [{
    ...
    key: '_handlePopoverRequestClose',
    value: function _handlePopoverRequestClose() {
...
AutoComplete.propTypes = {
   ...
   * @var {array}
   */
  suggestionData: _react2.default.PropTypes.array,
   ...
   * @var {array}
   */
  filterData: _react2.default.PropTypes.bool,
   ...
   * @var {object}
   */
  inputDetails: _react2.default.PropTypes.object,
   ...
   * @var {int}
   */
  keyPressedValue: _react2.default.PropTypes.number,
