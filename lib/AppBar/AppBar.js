  ...
  _createClass(AppBar, [{
    ...
    value: function render() {
      ...
      if (this.props.iconElementLeft) {
        ...
        var iconElementLeft = this.props.iconElementLeft;
      ...
      var rightElements = this.props.iconElementRight ? this.props.iconElementRight : null;
      ...
      if (this.props.title) {
        ...
        elementCenter = toString.call(this.props.title) === '[object String]' ? _react2.default.createElement(
          'h1',
          { className: theme.appBarCenter },
          this.props.title
        ) : this.props.title;
      } else if (this.props.children) {
        elementCenter = _react2.default.createElement(
          'div',
          { className: theme.appBarCenter },
          this.props.children
        );
...
AppBar.propTypes = {
  onNavBtnClick: _propTypes2.default.func,
  className: _propTypes2.default.string,
  iconElementLeft: _propTypes2.default.element,
  iconElementRight: _propTypes2.default.oneOfType([_propTypes2.default.element, _propTypes2.default.array]),
