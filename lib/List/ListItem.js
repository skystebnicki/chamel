...
var ListItem = function ListItem(props, context) {
  ...
  var onLeftElementTap = props.onLeftElementTap || onTap;

  // If we have a left element add it
  var leftElement = null;
  if (props.leftElement) {
    var leftIcon = props.selected && props.selectedShowCheckbox ? _react2.default.createElement(_Checkbox2.default, { checked: true }) : props.leftElement;

    leftElement = _react2.default.createElement(
      'div',
      { onClick: onLeftElementTap, className: theme.listItemLeft },
      leftIcon
    );
  }
...
ListItem.propTypes = {
   ...
   */
  selectedShowCheckbox: _propTypes2.default.bool,
   ...
   */
  onLeftElementTap: _propTypes2.default.func
};
