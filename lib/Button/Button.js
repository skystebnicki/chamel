...
var Button = function Button(props, context) {
    ...
    var type = props.type;
    var classes = (0, _classnames3.default)(theme[type], (_classnames = {}, _defineProperty(_classnames, theme[type + "primary"], props.primary), _defineProperty(_classnames, theme[type + "accent"], props.accent), _defineProperty(_classnames, theme[type + "disabled"], props.disabled), _defineProperty(_classnames, theme[type + "mini"], props.mini), _classnames), className);
