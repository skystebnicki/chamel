...
var IconButton = function IconButton(props, context) {
    ...
    var children = props.iconClassName && props.children.length == 0 ? _react2.default.createElement(_FontIcon2.default, { className: props.iconClassName }) : props.children;
