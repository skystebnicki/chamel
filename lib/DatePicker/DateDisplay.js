...
var DateDisplay = function (_Component) {
  ...
  function DateDisplay() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DateDisplay.__proto__ || Object.getPrototypeOf(DateDisplay)).call.apply(_ref, [this].concat(args))), _this), _this.getClasses = function (initialClasses, additionalClassObj) {
      var classString = '';
