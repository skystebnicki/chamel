...
var DayButton = function (_Component) {
  ...
  function DayButton() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DayButton.__proto__ || Object.getPrototypeOf(DayButton)).call.apply(_ref, [this].concat(args))), _this), _this._handleTouchTap = function (e) {
      if (_this.props.onClick) _this.props.onClick(e, _this.props.date);
  ...
  _createClass(DayButton, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          other = _objectWithoutProperties(_props, ['className', 'date', 'onClick', 'selected']);
