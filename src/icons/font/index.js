...
const Icons = {
  navigation: [
    ...
    {name:"arrow drop down", icon: ArrowDropDownIcon},
    {name:"arrow drop down circle", icon: ArrowDropDownCircleIcon},
    {name:"arrow drop up", icon: ArrowDropUpIcon},
    ...
    {name:"library books", icon: LibraryBooksIcon},
    ...
    {name:"settings application", icon: SettingsApplication},
    {name:"shuffle", icon: ShuffleIcon},
    {name:"street view", icon: StreetViewIcon},
    {name:"sub arrow left", icon: SubArrowLeftIcon},
    {name:"sub arrow right", icon: SubArrowRightIcon},
    {name:"swap horiz", icon: SwapHorizIcon},
    {name:"tag", icon: LocalOfferIcon},
  ...
  editor: [
    ...
    {name:"list numbered", icon: ListNumberedIcon},
    {name:"list bulleted", icon: ListBulletedIcon},
    {name:"title", icon: TitleIcon},
    {name:"web", icon: WebIcon},
    {name:"underlined", icon: UnderlinedIcon}
  ]
};
